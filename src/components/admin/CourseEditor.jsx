...
let CourseEditor = React.createClass({
    ...
    approve() {
        ...
        if (this.props.course.id) {
            CourseClient.editCourse(course.id, data, (data) => {
